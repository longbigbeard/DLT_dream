...
if __name__ == '__main__':
    ...
    hit_list_now = []
    hit_list_old = []
    for check_list in old_list:
    # for check_list in now_list:
        hit_list_now += check_num(check_list, '21010')
        hit_list_old += check_num(check_list)

    print("=======================================最近数据======================================================")
    print("---------------------------------------可观金额------------------------------------------------------")
    for x in hit_list_now:
        if x['hit_num_money'] > 100:
            print(x)
    print("---------------------------------------全部所得------------------------------------------------------")
    for x in hit_list_now:
        print(x)
